...
function db_machine(control,msg){
  ...
  if (control == "delete"){
    ...
    machineDB.push({name: msg.name, type: msg.type, template: msg.template, flavour: msg.flavour, comment: msg.comment, createTime: msg.createTime, modifyTime: msg.modifyTime, boot: "0"});
  }
